...
const envSchema = z.object({
  ...
  UNDERSTANDING_MODEL_URL: z.string().optional().or(z.literal("")),
  UNDERSTANDING_MODEL_TOKEN: z.string().optional(),
  UNDERSTANDING_MODEL_MODE: z.enum(["shadow", "assist"]).default("shadow"),
  UNDERSTANDING_MODEL_TIMEOUT_MS: z.string().optional(),
